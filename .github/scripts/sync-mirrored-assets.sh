...
sync_release "SagerNet/sing-box" "mirror-SagerNet-sing-box-" 6
sync_release "XTLS/Xray-core" "mirror-XTLS-Xray-core-" 8
sync_release "Loyalsoldier/v2ray-rules-dat" "mirror-Loyalsoldier-v2ray-rules-dat-" 2
sync_release "XTLS/RealiTLScanner" "mirror-XTLS-RealiTLScanner-" 1
sync_release "v2fly/v2ray-core" "mirror-v2fly-v2ray-core-" 5
sync_release "apernet/hysteria" "mirror-apernet-hysteria-" 5
sync_release "EAimTY/tuic" "mirror-EAimTY-tuic-" 1

sync_single_url_release "mirror-badafans-warp-reg-v1.0" "Mirror badafans/warp-reg v1.0" \
  "https://github.com/badafans/warp-reg/releases/download/v1.0/warp-reg-linux-amd64" "warp-reg-linux-amd64" \
  "https://github.com/badafans/warp-reg/releases/download/v1.0/warp-reg-linux-arm64" "warp-reg-linux-arm64" \
  "https://github.com/badafans/warp-reg/releases/download/v1.0/warp-reg-linux-arm" "warp-reg-linux-arm"
...
sync_single_url_release "mirror-MetaCubeX-meta-rules-dat-release" "Mirror MetaCubeX/meta-rules-dat release files" \
  "https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/geoip.dat" "geoip.dat" \
  "https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/geosite.dat" "geosite.dat" \
  "https://fastly.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/geoip.metadb" "geoip.metadb" \
  "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@release/country.mmdb" "country.mmdb"
